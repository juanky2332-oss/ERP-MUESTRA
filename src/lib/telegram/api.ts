...
export const COMANDOS_BOT = [
    ...
    { command: 'albaranes', description: 'Albaranes sin facturar y sin firma' },
    { command: 'firmado', description: 'Subir un albarán o parte firmado' },
    { command: 'firmados', description: 'Control de albaranes y partes firmados' },
    { command: 'informe', description: 'Informes: /informe marzo, trimestre, año' },
    { command: 'expediente', description: 'Factura + albaranes + firmas en un PDF' },
