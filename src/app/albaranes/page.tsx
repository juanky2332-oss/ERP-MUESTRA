...
import { Plus, Search, FileText, Eye, Trash2, Loader2, Edit, Check, Mail, ArrowRight, ChevronsUpDown } from 'lucide-react'
                                                ...
                                                {filteredClients.length === 0 ? (
                                                    ...
                                                    filteredClients.map((client, idx) => (
                                                        <div
                                                            ...
                                                            className={cn(
                                                                "px-3 py-2.5 cursor-pointer transition-colors hover:bg-purple-50 border-b border-slate-50 last:border-0",
                                                                editingDoc.cliente_razon_social === client.cliente_razon_social && "bg-purple-50"
                                                            )}
                                                            onClick={() => {
                                                                setEditingDoc({
                                                                    ...editingDoc,
