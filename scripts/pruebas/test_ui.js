...
;(async () => {
    ...
    try {
        ...
        // La app trabaja con la fecha de Madrid (no UTC).
        const esperado = (() => { const hoy = new Intl.DateTimeFormat('en-CA', { timeZone: 'Europe/Madrid' }).format(new Date()); const d = new Date(hoy + 'T12:00:00Z'); d.setUTCDate(d.getUTCDate() + 60); return d.toISOString().slice(0, 10) })()
